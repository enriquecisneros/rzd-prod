...
$(function() {
    ...
    $(window).scroll(function() {
        ...
        if (scroll >= 70) {
            header.removeClass('top').addClass("top-scroll");
		} else {
            header.removeClass("top-scroll").addClass('top');
 ...
 $(function() {
    ...
    $(window).scroll(function() {
        ...
        if (scroll >= 500) {
            header.removeClass('plain').addClass("nav-fix");
		} else {
            header.removeClass("nav-fix").addClass('plain');
...
$(function() {
    ...
    $(window).scroll(function() {
        ...
        if (scroll >= 500) {
            header.removeClass('og-nav').addClass("go-nav");
		} else {
            header.removeClass("go-nav").addClass('og-nav');
